...
# $Header: /var/cvsroot/gentoo-x86/mail-client/mail-notification/mail-notification-5.4-r7.ebuild,v 1.5 2014/02/22 22:56:56 pacho Exp $
...
src_prepare() {
	...
	sed -i -e '/jb_compile_options_add.*bsd-compat/d' jbsrc/jb.c || die
}
