...
src_prepare() {
	...
	# http://permalink.gmane.org/gmane.comp.video.mesa3d.scm/46235
	# xa_tracker.c:147:5: error: implicit declaration of function 'pipe_loader_drm_probe_fd'
	epatch "${FILESDIR}"/implicit_pipe_loader_drm_probe_fd.patch
